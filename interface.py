...
pygame.display.set_caption("Controlador Manual - Red Dragons - 2024v1")
...
keys = {
    ...
    "Q": pygame.Rect(120, 240, *key_size),
    "E": pygame.Rect(200, 240, *key_size),
    ...
    "U": pygame.Rect(120+300, 240, *key_size),
    "O": pygame.Rect(200+300, 240, *key_size),
    ...
    "4": pygame.Rect(120+600, 240, *key_size),
    "6": pygame.Rect(200+600, 240, *key_size),
}
...
imput_texts["linear_0"] = "0.5"
imput_texts["angular_0"] = "10.0"
imput_texts["linear_1"] = "0.5"
imput_texts["angular_1"] = "10.0"
imput_texts["linear_2"] = "0.5"
imput_texts["angular_2"] = "10.0"
...
while running:
    ...
    if active_box is None:
        if connected:
            actuator.send_localVelocity_message(0, vx_0, vy_0, w_0)
            actuator.send_localVelocity_message(1, vx_1, vy_1, w_1)
            actuator.send_localVelocity_message(2, vx_2, vy_2, w_2)
